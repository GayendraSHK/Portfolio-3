    ...
    <nav className="sticky top-3 z-[80] mb-6">
      <div className="panel-card px-3 py-3 sm:px-4 sm:py-2.5 md:px-5 md:py-3 backdrop-blur-sm">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between lg:gap-4">
          ...
          <ul
            className={`mt-3 grid grid-cols-2 gap-2 ${menuOpen ? "" : "hidden"} md:mt-0 md:ml-3 md:flex md:w-auto md:flex-wrap md:items-center md:justify-end md:gap-1 lg:mt-0 lg:flex lg:flex-1 lg:flex-nowrap lg:items-center lg:justify-end lg:gap-2`}
            id="navbar-default"
          >
            {navItems.map((item) => (
              <li key={item.href}>
